...
public class MainMemory extends AbstractMainMemory {
  ...
  @Override public int bytesToInteger (byte byteAtAddrPlus0, byte byteAtAddrPlus1, byte byteAtAddrPlus2, byte byteAtAddrPlus3) {
      int big = 0;
      big += (byteAtAddrPlus0 & 0xff) << 24;
      big += (byteAtAddrPlus1 & 0xff) << 16;
      big += (byteAtAddrPlus2 & 0xff) << 8;
      big += (byteAtAddrPlus3 & 0xff);
      return big;
  }
  ...
  @Override public byte[] integerToBytes (int i) {
      ...
      converted[0] = (byte) (i >>> 24);
      converted[1] = (byte) (i >>> 16);
      converted[2] = (byte) (i >>> 8);
      converted[3] = (byte) i;
      return converted;
  }
